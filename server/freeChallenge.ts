...
export const defaultGames: GameConfig[] = [
  {
    ...
    title: 'اختلاف الصورة والبحث عن المختلف',
    description: 'حدد العنصر المختلف أو الفارق بين العناصر المعروضة بأعلى دقة وتركيز بصري.',
    icon: 'Eye',
  ...
  },
  {
    ...
    title: 'مطابقة الظلال الدقيقة',
    description: 'قارن تفاصيل الأشكال وظلالها الدقيقة واختر الظل المطابق بنسبة 100%.',
    icon: 'Layers',
  ...
  },
  {
    ...
    title: 'إكمال الأنماط الهندسية',
    description: 'اكتشف التسلسل المنطقي وأكمل النمط الرياضي أو البصري الناقص بدقة.',
    icon: 'Grid',
  ...
  },
  {
    ...
    title: 'تحدي العد والتركيز السريع',
    description: 'قم بإحصاء عدد الأدوات والعناصر المحددة المعروضة بأسرع وقت ممكن.',
    icon: 'Hash',
  ...
  },
  {
    id: 'g_shape_sort',
    type: 'shape_sorting',
    title: 'فرز ومطابقة الأشكال',
    description: 'رتب وفرز الأشكال والأدوات الهندسية وفق قواعد التصنيف واللون.',
    icon: 'Boxes',
  ...
  },
  {
    id: 'g_visual_memory',
    type: 'visual_memory',
    title: 'الذاكرة البصرية السريعة',
    description: 'احفظ مواقع الرموز والأدوات والبطاقات واسترجعها بعد إخفائها.',
    icon: 'Brain',
  ...
  },
  {
    ...
    title: 'القطعة الناقصة من التركيب',
    description: 'اختر القطعة الهندسية المناسبة تماماً لإكمال الصورة أو اللوحة الفنية.',
    icon: 'Puzzle',
