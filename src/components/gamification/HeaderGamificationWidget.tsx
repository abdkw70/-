    ...
    <div className="flex items-center gap-1 sm:gap-2 shrink-0">
      ...
      {isChallengeEnabled && (
        <button
          ...
          className="relative group hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-gradient-to-r from-amber-500/15 via-amber-500/25 to-amber-500/15 border border-amber-500/40 text-amber-700 hover:text-amber-900 hover:border-amber-500 transition-all text-xs font-extrabold shadow-2xs cursor-pointer active:scale-95 shrink-0 touch-manipulation min-h-[36px] justify-center"
        ...
        >
          ...
          <span className="whitespace-nowrap">{t('games.play_win_short')}</span>
        </button>
      )}
      ...
      {user && (
        <button
          ...
          className={`hidden xs:flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl border text-xs font-bold transition-all cursor-pointer shrink-0 touch-manipulation min-h-[36px] justify-center ${
            activeBalance > 0
        ...
        >
          ...
          <span className="text-[10px] text-slate-500 whitespace-nowrap">{t('common.kwd')}</span>
        </button>
      )}
      ...
      {user ? (
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 border border-slate-200 text-xs font-semibold text-slate-800 transition-colors cursor-pointer shrink-0 touch-manipulation min-h-[36px] justify-center"
          title={t('games.my_account_tiers')}
          aria-label={t('games.my_account_tiers')}
        >
          {getTierIcon()}
          <span className="max-w-[110px] truncate font-bold text-xs whitespace-nowrap">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-amber-50 hover:border-amber-300 border border-slate-200 text-xs font-bold text-slate-700 hover:text-amber-700 transition-all cursor-pointer shrink-0 touch-manipulation min-h-[36px] justify-center"
