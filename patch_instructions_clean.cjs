...
const regex = /let baseInstruction = \`أنت موظف مبيعات حقيقي وطبيعي[\s\S]*?تنبيه هام جداً: إياك أن تخترع مقابض \(handles\) من عندك[\s\S]*?\`;/m;

const replacement = `let baseInstruction = \`أنت موظف مبيعات حقيقي وطبيعي داخل "مكتبة الشاطئ الأزرق" (Blue Beach Stationery) في الكويت.
